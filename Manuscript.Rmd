...
library(tidyverse)
load("~/MissingThePoint/Data/results_standard_ci.Rdata")
...
Missing data poses a ubiquitous threat against unbiased, confidence-valid statistical inferences. A popular tool to accommodate missing data. With techniques like multiple imputation (Rubin, 1987), missing data points are imputed (i.e., 'filled in')
