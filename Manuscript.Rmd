...
We propose a novel multivariate parameter to check for non-convergence in iterative algorithms. Our aim is to show which method (parameter + diagnostic + threshold) is the most informative about non-convergence in the iterative imputation algorithm implemented in `mice`.
